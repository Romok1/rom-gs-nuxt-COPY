...
ComfortableMexicanSofa::AccessControl::AdminAuthentication.username = Rails.application.credentials[Rails.env.to_sym][:comfy][:username]
ComfortableMexicanSofa::AccessControl::AdminAuthentication.password = Rails.application.credentials[Rails.env.to_sym][:comfy][:password]
